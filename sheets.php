...
<html lang="en">
    ...
    $sql = "INSERT INTO `sheets`  VALUES ('','$name','$category','$fileurl','$img')";
                            ...
                            <table class="highlight stripped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $r['fileurl']; ?></td>
                                        <td><?php echo $r['imgurl']; ?></td>
                                        <td><a href="/epatashala/deletesheets.php?id=<?php echo $r['id']; ?>">Delete</a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
