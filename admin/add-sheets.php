    ...
    <body>
        ...
        <main>
            ...
            <div class="card-panel center">
                <span class="green-text text-darken-2">Add Cheat Sheets or Other</span>
            </div>
            <div class="container ">
...
if (isset($_POST['name']) & !empty($_POST)) {
    ...
    $sql = "INSERT INTO `sheets`  VALUES ('','$name','$category','$fileurl','$imgurl')";
                                   ...
                                   <input type="text"  name="fileurl" >
                                    ...
                                    <div class="input-field col s12">
                                        <select name="category">
                                            ...
                                            <option value="1">Cheet Sheats</option>
                            ...
                            <table class="highlight stripped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?php echo $r['imgurl']; ?>" width="30px" height="30px"></td>
                                        <td><a href="<?php echo $r['fileurl']; ?>">View</a></td>
                                        <td><a href="/epatashala/admin/delete-sheets.php?id=<?php echo $r['id']; ?>">Delete</a></td>
                                    </tr>
                                    <?php
} ?>
                                </tbody>
